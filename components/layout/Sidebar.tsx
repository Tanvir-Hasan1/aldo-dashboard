      ...
      <div className="flex h-full flex-col px-4 py-6">
        ...
        <div className="mb-10 flex items-center justify-center gap-3 px-2 md:justify-start">
          ...
          <span className="hidden text-xl font-bold tracking-tight text-gray-900 dark:text-white md:block">
            Risto <span className="text-[var(--color-primary)]">AI</span>
          </span>
        </div>
        ...
        <div className="mt-auto border-t border-gray-100 pt-6 dark:border-gray-800">
          <button
            ...
            className="w-full group flex items-center justify-center gap-3 rounded-xl p-3 text-sm font-semibold text-gray-500 transition-all hover:bg-red-50 hover:text-red-600 dark:text-gray-400 dark:hover:bg-red-900/10 md:justify-start md:px-4 md:py-3.5"
          >
